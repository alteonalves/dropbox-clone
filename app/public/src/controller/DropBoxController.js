class DropBoxController {
	...
	constructor() {
		...
		this.initEvents();
		//Abre a pasta principal e lê os arquivos
		this.openFolder();
	}
	//Conecta com o banco firebase
	connectFirebase() {
		// Your web app's Firebase configuration
		// For Firebase JS SDK v7.20.0 and later, measurementId is optional
		var firebaseConfig = {
			apiKey: "AIzaSyDDZBqE02BXDXy1GMwTO-h2sTfBxRhvcz0",
			authDomain: "dropbox-clone-teo.firebaseapp.com",
			databaseURL: "https://dropbox-clone-teo-default-rtdb.firebaseio.com",
			projectId: "dropbox-clone-teo",
			storageBucket: "dropbox-clone-teo.appspot.com",
			messagingSenderId: "347693988936",
			appId: "1:347693988936:web:c5d1a16544af85c49bac7d",
			measurementId: "G-0ZCHKCHCRX"
		};
		// Initialize Firebase
	...
	ajax(url, method = 'GET', formData = new ForData(), onprogress = function () { }, onloadStart = function () { }) {
		...
		this.inputFilesEl.addEventListener('change', event => {
			...
			this.uploadTask(event.target.files).then(responses => {
				responses.forEach(resp => {
					//Alterado para pegar a url do arquivo nas novas versões do firebase storage
					//Testar em casa
	...
	uploadProgress(event, file) {
		...
		//Atualiza a barra de progresso de 0 a 100%
